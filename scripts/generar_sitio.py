...
function verPolla(ref, archivo) {{
  ...
  if (score && REALES && REALES.ronda_16avos) {{
    ...
    // Tabla de puntajes de finales
    html += '<div style="display:grid;grid-template-columns:1fr 1fr;gap:4px;margin:6px 0 8px;font-size:0.6rem;">';
    html += '<div style="background:#fff5f5;border-radius:6px;padding:6px;text-align:center;"><span style="color:#c0392b;font-weight:700;font-size:0.9rem;">1°</span><br><span style="color:#c0392b;">Campeón</span><br><strong style="font-size:0.8rem;">+20</strong></div>';
    html += '<div style="background:#f0f7ff;border-radius:6px;padding:6px;text-align:center;"><span style="color:#1a6fb5;font-weight:700;font-size:0.9rem;">2°</span><br><span style="color:#1a6fb5;">Segundo</span><br><strong style="font-size:0.8rem;">+11</strong></div>';
    html += '<div style="background:#faf5e8;border-radius:6px;padding:6px;text-align:center;"><span style="color:#b8860b;font-weight:700;font-size:0.9rem;">3°</span><br><span style="color:#b8860b;">Tercero</span><br><strong style="font-size:0.8rem;">+8</strong></div>';
    html += '<div style="background:#f5f5f5;border-radius:6px;padding:6px;text-align:center;"><span style="color:#666;font-weight:700;font-size:0.9rem;">4°</span><br><span style="color:#666;">Cuarto</span><br><strong style="font-size:0.8rem;">+5</strong></div>';
    html += '</div>';
    html += '</div>';
  }} else if (score) {{
